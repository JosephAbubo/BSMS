...
<?php 
	$user = $_SESSION['SAusername'];
	$query = "SELECT * FROM tbl_users WHERE NOT SAusername='$user' ORDER BY `created_at` DESC";
                        ...
                        <div class="modal-body">
							...
							<input type="hidden" name="size" value="1000000">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Enter Brgy." name="barangay" required>
                                </div>
                                <div class="form-group">
