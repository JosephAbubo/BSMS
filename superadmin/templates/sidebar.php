    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <div class="user">
                ...
                <div class="info">
                    <a data-toggle="collapse" href="<?= isset($_SESSION['SAusername']) && $_SESSION['role']=='administrator' ? '#collapseExample' : 'javascript:void(0)' ?>" aria-expanded="true">
                        <span>
                        <?= isset($_SESSION['SAusername']) ? ucfirst($_SESSION['SAusername']) : 'Guest User' ?>
                            <span class="user-level"><?= isset($_SESSION['role']) ? ucfirst($_SESSION['role']) : 'Guest' ?></span>
                        <?= isset($_SESSION['SAusername']) && $_SESSION['role']=='administrator' ? '<span class="caret"></span>' : null ?> 
                        </span>
                    </a>
            ...
            <ul class="nav nav-primary">
                ...
                <?php if(isset($_SESSION['SAusername']) && $_SESSION['role']=='staff'): ?>
