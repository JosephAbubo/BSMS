...
<section class="services">
   ...
   <div class="box-container">
      <div class="box">
         ...
         <h3><a href="resident_catbangen/residentlogin.php" target="_blank" class="nav__link">Barangay Catbangen Resident Log In</a></h3>
      </div>
      <div class="box">
         <img src="imagesv1/poro.png" alt="">
         <h3><a href="resident_poro/residentlogin.php" target="_blank" class="nav__link">Barangay Poro Resident Log In</a></h3>
      </div>
   </div>
   <br>
