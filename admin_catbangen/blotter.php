	...
	<div class="wrapper">
		...
		<div class="main-panel">
			<div class="content">
			 ...
			 <!-- Upload blotter photo -->
			 <div class="card-title">Upload blotter record Photo</div>
			 <div class="card-body">
                                <form enctype="multipart/form-data" action="" name="form" method="post">
                                        ...
                                        <?php
                                                ...
                                                $chk = $conn->query("SELECT * FROM  upload_blotter where name = '$name' ")->rowCount();
                                                if($chk){
                                                    $i = 1;
                                                    $c = 0;
                                                    while($c == 0){
                                                    ...
                                                    // var_dump($tname);exit;
                                                        $chk2 = $conn->query("SELECT * FROM  upload_blotter where name = '$tname' ")->rowCount();
                                                        if($chk2 == 0){
                                                            $c = 1;
                                                            $name = $tname;
                                                        }
                                                ...
                                                $move =  move_uploaded_file($temp,"upload_blotter/".$fname);
                                                if($move){
                                                    $query=$conn->query("insert into upload_blotter(name,fname)values('$name','$fname')");
                                                    if($query){
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                        ...
                                        <?php
                                        $query=$conn->query("select * from upload_blotter order by id desc");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="alert-success"><a href="../admin_catbangen/download_blotter.php?filename=<?php echo $name;?>&f=<?php echo $row['fname'] ?>">Download</a></button>
                                            </td>
                                        </tr>
                                        <?php }?>
                                    </table>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_blotter.php" >
								...
								<div class="col-md-6">
											<div class="form-group">
												<label>Full name of Captain</label>
												<input type="text" class="form-control" placeholder="Enter full name of Captain" name="kapitan"  value="<?= ucwords($captain['name']) ?>" required readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Full name of Secretary</label>
												<input type="text" class="form-control" placeholder="Enter full name of Secretary" name="sekretarya"  value="<?= ucwords($sec['name']) ?>" required readonly>
											</div>
										</div>
									</div>
								<div class="form-group">
