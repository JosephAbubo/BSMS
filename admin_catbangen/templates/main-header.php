...
<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
        ...
        <a href="dashboard.php" class="logo">
            <img src="assets/img/logo1.png" alt="navbar brand" class="navbar-brand"> <span class="text-light ml-2 fw-bold" style="font-size:13px">Agsirb - E</span>
        </a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a style ="
                         ...
                         ?>
                         " class="dropdown-item" href="schedules.php?id=<?php echo $i['id'] ?>">
                <small><i><?php echo date('F j, Y, g:i a',strtotime($i['date'])) ?></i></small><br/>
                  <?php 
                  
                if($i['type']=='comment'){
                    echo "Someone Message on Chat.";
                }else if($i['type']=='like'){
                    echo ucfirst($i['name'])."   Scheduled an Request of Document";
                }
