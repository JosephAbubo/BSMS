                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>National ID No. or any Govt ID No.</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" placeholder="Enter Password" name="password" id="password" value="agsirb-e_resident">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>National ID No. or any Govt ID no.</label>
                                        <input type="text" class="form-control" name="national" id="nat_id" placeholder="Enter ID No.">
                                    </div>
                                    <div class="form-group">
                                        <label>Citizenship</label>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control user_status" name="user_status" id="user_status">
