...
<?php 
    ...
    if($state=='male'){
        ...
        $query1 = "SELECT * FROM tblresident WHERE voterstatus='Yes' AND identified_as='Vaccinated' AND resident_type=1";
        $pos = $conn->query($query1)->num_rows;

        $query2 = "SELECT * FROM tblresident WHERE voterstatus='Yes' AND identified_as='Unvaccinated' AND resident_type=1";
