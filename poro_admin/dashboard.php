...
<?php 
	...
	$query8 = "SELECT * FROM tblresident WHERE identified_as='Vaccinated' AND resident_type=1";
	$positive = $conn->query($query8)->num_rows;

	$query9 = "SELECT * FROM tblresident WHERE identified_as='Unvaccinated' AND resident_type=1";
	$nega = $conn->query($query9)->num_rows;
		...
		<div class="main-panel">
			<div class="content">
				<div class="panel-header bg-primary-gradient">
					...
					<img src="assets/uploads/<?= $brgy_logo ?>" class="img-fluid" width="50" style="float:right">
				...
				<div class="page-inner mt--2">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="card card-stats card-round" style="background-color:#33B5FF; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												<h2 class="fw-bold text-uppercase">Vaccinated</h2>
												<h3 class="fw-bold text-uppercase"><?= number_format($positive) ?></h3>
											</div>
										</div>
									</div>
								</div>
								<div class="card-body">
									<a href="resident_info.php?state=all" class="card-link text-light">Vaccinated</a>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="card card-stats card-round" style="background-color:#1C1C2E; color:#fff">
								<div class="card-body">
									<div class="row">
										<div class="col-3">
											<div class="icon-big text-center">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												<h2 class="fw-bold text-uppercase">Non Vaccinated</h2>
												<h3 class="fw-bold text-uppercase"><?= number_format($nega) ?></h3>
											</div>
										</div>
									</div>
								</div>
								<div class="card-body">
									<a href="resident_info.php?state=all" class="card-link text-light">Non Vaccinated</a>
								</div>
							</div>
						</div>
