    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item <?= $current_page=='resident_clearance.php' || $current_page=='generate_brgy_clearance.php' ? 'active' : null ?>">
                    <a href="resident_clearance.php">
                ...
                <li class="nav-item <?= $current_page=='addQrCode.php' || $current_page=='#'  ? 'active' : null ?>">
                    <a href="addQrCode.php">
                        <i class="icon-list"></i>
                        <p>Generate QR</p>
                    </a>
                </li>
                 
                    <li class="nav-item <?= $current_page=='schedules.php' || $current_page=='#'  ? 'active' : null ?>">
