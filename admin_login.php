...
<section class="services">
   ...
   <h1 class="heading-title"> Barangays of City of San Fernando </h1>

   <div class="box-container">
      <div class="box">
         <img src="imagesv1/catbangen.png" alt="">
         <h3><a href="admin_catbangen/login.php" target="_blank" class="nav__link">Barangay Catbangen Admin Log In</a></h3>
      </div>
      <div class="box">
         <img src="imagesv1/poro.png" alt="">
         <h3><a href="poro_admin/login.php" target="_blank" class="nav__link">Barangay Poro Admin Log In</a></h3>
      </div>
   </div>
   <br>
